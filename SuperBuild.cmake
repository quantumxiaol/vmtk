...
##
if( VMTK_ENABLE_SEGMENTATION AND NOT USE_SYSTEM_ITK )
...
if (VMTK_ENABLE_SEGMENTATION)
  list(APPEND VMTK_OPTIONAL_EXTERNALPROJECT_ARGS
...
ExternalProject_Add( ${proj}
  ...
  CMAKE_ARGS
    ...
    -DVMTK_ENABLE_SEGMENTATION:BOOL=${VMTK_ENABLE_SEGMENTATION}
    ...
    -DCMAKE_INSTALL_RPATH=${SUPERBUILD_INSTALL_PREFIX}/lib;@rpath
    -DCMAKE_INSTALL_RPATH_USE_LINK_PATH=TRUE
    ${VMTK_OPTIONAL_EXTERNALPROJECT_ARGS}
